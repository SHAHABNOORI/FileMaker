...
namespace FileMaker.Infrastructure.Helpers
{
    public static class EnumHelper
    {
        ...
        {
            return (TEnum)System.Enum.ToObject(typeof(TEnum), enumValue);
        }
        ...
        {
            return System.Enum.GetValues(typeof(T)).Cast<int>().Max();
        }
        ...
        {
            return System.Enum.GetValues(typeof(T)).Cast<int>().Min();
        }
